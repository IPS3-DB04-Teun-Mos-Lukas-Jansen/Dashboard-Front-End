...
export default function CurrentWeatherCard(id, column, isDummy) {
    ...
    useEffect(() => {
        ...
        GetCurrentWeatherForecast().then((data) => {
            SetWeatherData(data);
            console.log(data);
    ...
    function InitBackground() {
        if (WeatherData != null) {
            ...
            console.log(WeatherData.imgName);
            ...
            switch (WeatherData.imgName) {
                case "01d":
                    // Clear sky
                    imgurl = "https://cdn.pixabay.com/photo/2018/08/06/22/55/sun-3588618__340.jpg";
                    break;
                case "01n":
                    // Clear sky night
                    imgurl = "https://media.istockphoto.com/id/826672506/photo/night-sky-with-stars.jpg?s=612x612&w=0&k=20&c=lPeDcgxVYmPQrWcuXQuT-bCsL28ZKWCMwO3A8IrmvRo=";
                    break;
                case "02d":
                    // Few clouds
                    imgurl = "https://media.istockphoto.com/id/171225633/photo/deep-blue-view-on-a-lightly-clouded-day.jpg?s=612x612&w=0&k=20&c=KGV9ieDdP5wgx9unc_HwHmP5wuRmpgyDSA0h-3_gNNo=";
                    break;
                case "02n":
                    // Few clouds night
                    imgurl = "https://media.istockphoto.com/id/1154430991/photo/dark-blue-storm-cloudy-sky-background.jpg?b=1&s=170667a&w=0&k=20&c=nyurCBs4SGGjny4MRhJdb4aQXc9MS1pj5VCw1XV4uKA=";
                    break;
                case "03d":
                    // Scattered clouds
                    imgurl = "https://images.squarespace-cdn.com/content/v1/5d4c63022fdc0f0001a31f58/1565863502860-U636YZGVWKQJ47331LG6/cloud+dark+blue.jpg?format=2500w";
                    break;
                case "03n":
                ...
                case "50d":
                    // Mist
                    imgurl = "https://www.anwb.nl/binaries/content/gallery/anwb/nieuws/verkeer/redesign-standaard-beelden/weer-en-waarschuwing/mist-onderweg-verkeer-1520-x-855.jpg/mist-onderweg-verkeer-1520-x-855.jpg/anwb%3Aw760";
                    break;
                case "50n":
                    // Mist night
                    imgurl = "https://www.anwb.nl/binaries/content/gallery/anwb/nieuws/verkeer/redesign-standaard-beelden/weer-en-waarschuwing/mist-onderweg-verkeer-1520-x-855.jpg/mist-onderweg-verkeer-1520-x-855.jpg/anwb%3Aw760";
            ...
            document.getElementById(id + "W").style.transform = "rotate( " + WeatherData.windDirection + "deg)";
                            ...
                            {(close) => (
                                <Popup trigger={
                                    <div className="integration-info-view-more-popup">
                                        <div onClick={() => { }} className="integration-info-view-more-popup-item integration-info-view-more-popup-item-delete">
                                            <div>
                                                <div />
                                            </div>
                                            Remove
                                    ...
                                    {(close2) => (
                                        <div className="integration-info-view-more-popup-modal">
                                            ...
                                            <div className="integration-info-view-more-popup-modal-buttons">
                                                <button onClick={async () => {await RemoveCard(); close2(); close(); }} className="">
                                                    Yes, delete this card.
                                                </button>
                                                <button onClick={ () => { close2(); close();  }} className="">
                                                    No
                                                </button>
                    ...
                    WeatherData != null ? (
                        <div className="current-weather-card-content">
                            <div className="current-weather-card-image-container">
                                <img className="current-weather-card-image" src={WeatherData.imgUrl} alt="Weather Icon" />
                            ...
                            <div className="current-weather-card-wind-container">
                                <div id={id + "W"} className="current-weather-card-wind">
                                    <img className="current-weather-card-wind-image" src={WindImg} alt="Wind Icon" />
                                </div>
